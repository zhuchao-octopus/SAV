...
public class MainActivity extends Activity implements OnTouchListener, OnGlobalFocusChangeListener, NetChangedCallBack,
    ...
    private final String host = "http://test.jhxdesign.cn:8080/";    //  （节流）
    private final String lunchname = "SAV";
    private final String appName = "SAV";      //（精合智国内）
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            TimeDateUtils.setTimeZone(MainActivity.this.getApplicationContext(), "Asia/Shanghai");
    ...
    public void onClick(View v) {
        int b = binding.ivFill.getVisibility();
        if (b == View.VISIBLE) return;

        Log.d(TAG,"binding.ivFill.getVisibility()="+b);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (binding.ivFill.getVisibility() == View.VISIBLE)
            return true;
